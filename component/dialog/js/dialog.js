...
define(function(require,exports,module){
	...
	var dialog = function (options){
		...
		this.options = $.extend({
			...
			contentLink:'',//弹出远程资源(若子页面的真实内容宽度小于300，需要在body上赋值宽度真实值，例如《<body style="width:200px">》即可)
			masked:true
		},options);
	...
	dialog.prototype.remotePopup = function(){
		...
		util.iframeReady(iframeDom,function(){
			...
			var childBodyWidth = iframeDomDocument.body.clientWidth ,
				childBodyHeight = iframeDomDocument.body.clientHeight ,
